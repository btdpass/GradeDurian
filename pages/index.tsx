		...
		<div className="text-left px-9 sm:px-12 md:px-24 lg:px-36 xl:px-48 py-5 md:py-10 overflow-hidden">
			...
			<div className="grid max-w-screen-xl py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:max-w-none lg:space-x-8 lg:items-center">
				<div className="mr-auto place-self-center lg:col-span-7">
					...
					>
						Grade Durian is an all new third party alternative
				...
				<div className="hidden lg:block dark:hidden lg:mt-0 lg:col-span-5">
					<motion.img
						...
						src={`${process.env.NEXT_PUBLIC_BASE_PATH}/assets/herolight.svg`}
						alt="mockup"
					/>
				</div>
				<div className="hidden lg:mt-0 lg:col-span-5 lg:dark:block">
					<motion.img
						...
						transition={{ delay: 0.3, duration: 0.5 }}
						className="h-96 w-full"
						src={`${process.env.NEXT_PUBLIC_BASE_PATH}/assets/hero.svg`}
						alt="mockup"
					/>
				</div>
			</div>
			...
			<div className="gap-8 items-center md:pt-5 md:pb-0 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 ">
				<div className="mt-4 md:mt-0">
					...
					>
						{/* {`Grade Durian is committed to maintaing transparency! If you're interested in getting access to the source code,
						send us an email at support@gradedurian`} */}
						Grade Durian is committed to maintaining transparency! If you&apos;re interested in getting access to the source code, just view our{" "}
						<a href={`https://github.com/${process.env.NEXT_PUBLIC_GITHUB_REPO}`} target="_blank" rel="noreferrer" className="text-primary-500 underline">GitHub repository</a>.
				...
				<motion.img
					...
					src={`${process.env.NEXT_PUBLIC_BASE_PATH}/assets/opensourcelight.svg`}
					alt="Open Source"
				/>
				<motion.img
					initial={{ y: 50, opacity: 0 }}
					...
					src={`${process.env.NEXT_PUBLIC_BASE_PATH}/assets/opensource.svg`}
					alt="Open Source"
				/>
			</div>
			...
			<Link href="mailto:support@gradedurian">
				<motion.p
					initial={{ x: 0, opacity: 0 }}
					animate={{ x: 0, opacity: 1 }}
				...
				>
					<HiOutlineMail size="1.3rem" /> support@gradedurian
				</motion.p>
			</Link> */}
